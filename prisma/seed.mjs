...
const connectionString = "postgresql://postgres:cuellogey@localhost:5432/taller3_db? schema=public";
...
const tagOptions = [
  "urgente", "revision", "aprobado", "Q4", "Q1",
  "proyecto-alpha", "cliente-vip", "interno", "externo", "prioritario",
];
